        ...
        <div className="m-4">
          ...
          <div className="w-full px-7 py-10  rounded-lg mt-4 bg-[#5d5d5d26]  backdrop-filter backdrop-blur-sm flex justify-center items-center">
            <div className="max-w-lg mx-auto  shadow-md rounded-lg flex justify-center items-center flex-col font-popin">
              ...
              <p className="text-[20px]">Image Generation </p>
              <p className="text-[#F5F5F5] text-base mt-2">
              ...
              <div className="py-4 w-full">
                <button className="w-full py-3 bg-gradient-to-r from-blue-500 to-teal-400 bg-slate-600 text-center rounded-[50px] mt-3 cursor-pointer ">
                  Generate Images
                </button>
              </div>
            </div>
          ...
          <div className="flex justify-between mb-4 mt-8 ">
            ...
            <div className="flex center items-center text-[#F4F4F4]">
              <p className="pr-2 text-[20px]">View All</p>
